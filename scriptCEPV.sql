...
alter FUNCTION [dbo].[fnSplit] ( @sep CHAR(1), @str VARCHAR(512) )
 ...
 VL_CONTRASE�A VARCHAR(30) NOT NULL,
 FH_REGISTRO DATETIME DEFAULT GETDATE(),
 CONSTRAINT PK_USUARIO PRIMARY KEY(ID_USUARIO),
 CONSTRAINT UN_USUARIO UNIQUE(NB_USUARIO)
 ) 

 INSERT INTO USUARIOS ([NB_USUARIO],[VL_CONTRASE�A]) VALUES ('admin','abc123')
 ...
 alter TRIGGER TG_NOTICIA_CATEGORIA
 ON NOTICIA
 AFTER INSERT
 AS
 BEGIN
 ...
 alter PROCEDURE SP_ADD_CATEGORIA_NOTICIA(
 @ACCION VARCHAR(30),
 @IDCAT INT,
 @NOTICIA VARCHAR(200),
 @USUARIO VARCHAR(30)
